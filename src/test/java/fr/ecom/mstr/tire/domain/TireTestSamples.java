...
public class TireTestSamples {
    ...
    public static Tire getTireSample1() {
        return new Tire()
            ...
            .name("name1")
            .tireWidth("tireWidth1")
            .tireHeight("tireHeight1")
            .tireDiameter("tireDiameter1")
            .imageUrl("imageUrl1")
            .quantity(1)
    ...
    public static Tire getTireSample2() {
        return new Tire()
            ...
            .name("name2")
            .tireWidth("tireWidth2")
            .tireHeight("tireHeight2")
            .tireDiameter("tireDiameter2")
            .imageUrl("imageUrl2")
            .quantity(2)
    ...
    public static Tire getTireRandomSampleGenerator() {
        return new Tire()
            ...
            .tireWidth(UUID.randomUUID().toString())
            .tireHeight(UUID.randomUUID().toString())
            .tireDiameter(UUID.randomUUID().toString())
