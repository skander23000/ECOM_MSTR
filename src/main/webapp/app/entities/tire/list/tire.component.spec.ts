...
import { sampleWithRequiredData } from '../tire.test-samples';
...
describe('Tire Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tires?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tireService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTireIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTireIdentifier).toHaveBeenCalledWith(entity);
